...
import com.org.shortener.domains.LoginDetails;
import com.org.shortener.exceptions.ShortenerException;
    ...
    private LoginDetails authenticate(String email) {
        try {
            ...
            if (userDocument.exists()) {
                com.org.shortener.domains.UserDetails userDetails
                        = userDocument.toObject(com.org.shortener.domains.UserDetails.class);
